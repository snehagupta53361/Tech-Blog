...
public class Posts {
    ...
    public Posts(String pTitle, String pContent, String pCode, String pPic, int catId) {
        this.pTitle = pTitle;
        this.pContent = pContent;
        this.pCode = pCode;
        this.pPic = pPic;
    ...
    public Posts(String ptitle, String pContent, String pcode, String pPic, int cid, int userId) {
        this.pTitle = ptitle;
        this.pContent = pContent;
        this.pCode = pcode;
        this.pPic = pPic;
